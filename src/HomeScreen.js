...
const itens = [
  ...
  {titulo: "Linha de Cuidado ao paciente com Calazar", icone: "ios-git-pull-request", screen: "Home"},
  {titulo: "Georreferenciamento dos casos", icone: "md-pin", screen: "Home"},
          ...
          ({item}) =>
            <TouchableOpacity onPress={()=>this.props.navigation.navigate(item.screen)}>
                <View style={estilo.card}>
                    <Ionicons name={item.icone} size={30} color="lightsalmon"/>
